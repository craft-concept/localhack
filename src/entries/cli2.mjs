...
import Build from "lib/transforms/Build"
import Files from "lib/transforms/Files"
import Markdown from "lib/transforms/Markdown"
import JsCompilation from "lib/transforms/JsCompilation"

const cwd = process.cwd()
const [node, bin, cmd, ...args] = process.argv
const self = new Transmute({
  cwd,
  cmd,
  args,
  files: {},
})
  .use(Build, Files, JsCompilation)
  .use(Markdown)
