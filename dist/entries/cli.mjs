#!/usr/bin/env node
import { sift, standard, current } from "../lib/sift.mjs";
...
function uiCmd(input) {
    ...
    return state => async (send) => {
        const child = execFile(electron, [project.file(project.entry("electron.js")), "main.mjs"], err => {
            if (err)
